...
All notable changes to CORE OS will be documented in this file.
...
- Added test runner CLI (`tests/runners/coreos-test-runner`) with TC-ID mapping and JSON reporting.
